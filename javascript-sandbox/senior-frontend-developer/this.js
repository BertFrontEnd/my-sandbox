...
// вызываемой функции через переменную можно передать параметры,
// но эти параметры можно передавать и в качестве аргумента метода bind после привязываемого контекста;
...
// параметры функции можно передавать в качестве аргумента метода call после привязываемого контекста;
// параметров может быть сколько угодно
...
// параметры функции можно передавать в качестве аргумента метода apply после привязываемого контекста;
// параметр может быть только один, и это массив;
// в массиве может быть сколько угодно элементов
...
// массив и число передаются как аргументы функции
...
// вызываем созданную функцию с нужными параметрами
...
// его не нужно передавать как параметр в какую-либо вызываемую функцию
